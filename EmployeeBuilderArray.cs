...
namespace EmployeeWageCalculation
{
    class EmployeeBuilderArray
    {
        ...
        {
            companyEmpWageArray[this.numOfCompany] = new CompanyEmployeeWage(companyName, employeeRatePerHour, numberOfWorkingDays, maxHrsInMonth);
            numOfCompany++;
        }
        /// <summary>
        ...
        public void ComputeEmployeeWage()
        {
            for (int i = 0; i < numOfCompany; i++)
            {
                ...
                Console.WriteLine(this.companyEmpWageArray[i].PrintTotalEmployeeWage());
            }
        }
        /// <summary>
